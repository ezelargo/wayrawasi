...
namespace WayraWasi.Data.Implementations
{
    public class CabaniaRepository : BaseRepository<Cabania>, ICabaniasRepository
    {
        ...
        public async Task<Cabania> BuscadorId(int id)
        {
            ...
            {
                return await conexionD.QuerySingleOrDefaultAsync<Cabania>("sp_BuscarCabaniaId",
                                                                          new { Id = id },
        ...
        public async Task<Cabania> BuscarPorNombre(string nombre, int id)
        {
            using (var conexionD = _conexionDapper.GetConnection())
            {
                return await conexionD.QuerySingleOrDefaultAsync<Cabania>("sp_BuscarCabaniaPorNombre",
